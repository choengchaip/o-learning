...
class ChangePasswordNewPasswordFeature extends StatefulWidget {
  final WidgetSliderRepository widgetSliderRepository;

  ChangePasswordNewPasswordFeature({
    @required this.widgetSliderRepository,
  });

  @override
  _ChangePasswordNewPasswordFeature createState() => _ChangePasswordNewPasswordFeature(
    widgetSliderRepository: this.widgetSliderRepository,
  );
}

class _ChangePasswordNewPasswordFeature
    extends State<ChangePasswordNewPasswordFeature> {
  final WidgetSliderRepository widgetSliderRepository;
  ...
  _ChangePasswordNewPasswordFeature({
    @required this.widgetSliderRepository,
  });
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      appLocaleRepo.$l('change_password', 'new_password_title'),
                      style: TextStyle(
